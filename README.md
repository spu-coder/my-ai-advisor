...
### 4. إضافة المستندات (اختياري) / Add Documents (Optional)
...
### 5. تشغيل النظام / Start the System
...
### 6. الوصول إلى التطبيق / Access the Application
...
```yaml
environment:
  - NEO4J_PASSWORD=YourStrongPassword123  # تغيير كلمة مرور Neo4j
  - SECRET_KEY=YourSuperSecretKey  # تغيير مفتاح JWT
```
...
# سجل الدخول بـ: neo4j / StrongPassword123
```
